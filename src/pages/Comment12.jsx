import C3 from "../assets/image-10.jpg";
    ...
    <div className='first-comment'>
      ...
      <Breadcrumbs />
        <div className="ourFirst">
            ...
            Thank you to all of our amazing fans for showing us so much love and support! We couldn't do this without you ❤️ #KpopLove #FanArmy</p>
              <div>
                      <svg className='comment' id="blog-13" stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"></path>
                        ...
                        <p className='comment-count'>{commentCounts['blog-13']}</p>
                        <p className='heart-count-1'>{heartCounts['heart-13']}</p>
                        <svg className={heart ('heart-13') } 
                        id='heart-first'
                        stroke="currentColor" 
                        fill="currentColor" 
                        strokeWidth="0" 
            ...
            <h3 className="h3-comment">Leave a Comment</h3>
              ...
              <div>
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">DARKPINK</p>
                  <p className="comment-text">We love you guys so much! Thank you for always inspiring us and making us smile ❤️ #ARMYForever</p>
                  <div className="comment-info">
                    <p className="comment-date">April 14, 2023
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">ONCE</p>
                  <p className="comment-text">You guys are the reason we do what we do! Thank you for being such an incredible fanbase 💕 #PINKS</p>
                  <div className="comment-info">
                    <p className="comment-date">April 14, 2023 <p className='comment-count' id="fave">{heartCounts['dark']}</p>
                    {<div className="comment-actions">
                    <svg
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">ECNO</p>
                  <p className="comment-text">We appreciate every single one of you! Thank you for always lifting us up 🙏 #FanLove</p>
                  <div className="comment-info">
                    <p className="comment-date">April 14, 2023 <p className='comment-count' id="fave">{heartCounts['MLS']}</p>
                    {<div className="comment-actions">
                    <svg
