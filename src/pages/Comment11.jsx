import C3 from "../assets/Image-9.jpg";
            ...
            <h3 className="h3-comment">Leave a Comment</h3>
              ...
              <div>
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="comment-text">You guys deserve this break so much! Enjoy the sun, sand, and sea 💙 #BlueCotton</p>
                  <div className="comment-info">
                    <p className="comment-date">June 27 2023
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="comment-text">Have an amazing time, girls! You deserve all the rest and relaxation in the world 🌴</p>
                  <div className="comment-info">
                    <p className="comment-date">June 27 2023 <p className='comment-count' id="fave">{heartCounts['dark']}</p>
                    {<div className="comment-actions">
                    <svg
