import C3 from "../assets/Image-15.jpg";
            ...
            <h3 className="h3-comment">Leave a Comment</h3>
              ...
              <div>
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">Tiffany</p>
                  <p className="comment-text">I'm sure you guys will rock the stage, Raymond! 🎤💜</p>
                  <div className="comment-info">
                    <p className="comment-date">September 2, 2023
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="comment-text">I'm excited to see you perform again! 😍❤️</p>
                  <div className="comment-info">
                    <p className="comment-date">August 8, 2023<p className='comment-count' id="fave">{heartCounts['dark']}</p>
                    {<div className="comment-actions">
                    <svg
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="comment-text">Good luck with rehearsals! Can't wait to see the show 🤩</p>
                  <div className="comment-info">
                    <p className="comment-date">August 11, 2023<p className='comment-count' id="fave">{heartCounts['MLS']}</p>
                    {<div className="comment-actions">
                    <svg
