    ...
    <div className='first-comment'>
      ...
      <Breadcrumbs />
        <div className="ourFirst">
            <h1>New music video alert!</h1>
            <div className="comment-creator">
                <img className="comment-avatar" src={B1} alt="" />
                <p className='comment-name'>
                Lennie Win March 15, 2023              
                </p>
            </div>
           <br/>
            <p className='comment-post'>
            Pinks, the wait is over! Our new music video is out now! We worked so hard on this one, and we hope you love it as much as we do. Check it out and let us know what you think in the comments! ❤️ #DARKPINK #NewMusicVideo #LennieWin
           </p>
              <div>
            ...
            <h3 className="h3-comment">Leave a Comment</h3>
              ...
              <div>
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">David Candes</p>
                  <p className="comment-text">OMG Lennie, the music video is AMAZING! I've been playing it on repeat all day. You guys really outdid yourselves this time! 🔥</p>
                  <div className="comment-info">
                    <p className="comment-date">March 15, 2023 <p className='comment-count' id="fave">{heartCounts['heart-jc']}</p>
                    {<div className="comment-actions">
                    <svg
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">Mints</p>
                  <p className="comment-text">You guys never disappoint! This music video is on another level. I can't stop watching it 😍</p>
                  <div className="comment-info">
                    <p className="comment-date">March 15, 2023 <p className='comment-count' id="fave">{heartCounts['dark']}</p>
                    {<div className="comment-actions">
                    <svg
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">Andy</p>
                  <p className="comment-text">I'm not even a Pink, but I have to admit, this music video is pretty epic. Congrats on another great release!</p>
                  <div className="comment-info">
                    <p className="comment-date">March 15, 2023 <p className='comment-count' id="fave">{heartCounts['MLS']}</p>
                    {<div className="comment-actions">
                    <svg
