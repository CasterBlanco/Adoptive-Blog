import C3 from "../assets/Image-2.png";
    ...
    <div className='first-comment'>
      ...
      <Breadcrumbs />
        <div className="ourFirst">
            <h1>New music dropping soon! 🎶🙌</h1>
            <div className="comment-creator">
                <img className="comment-avatar" src={B1} alt="" />
                <p className='comment-name'>
                DARKPINK Official September 2, 2022           
                </p>
            </div>
            <br/>
            <p className='comment-post'>
            Pinks, we're excited to announce that we have some new music coming your way very soon! We've been working hard on this project and can't wait for you all to hear it. Stay tuned for more updates! 🖤💗
           </p>
              <div>
                      <svg className='comment' id="blog-8" stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"></path>
                        ...
                        <p className='comment-count'>{commentCounts['blog-8']}</p>
                        <p className='heart-count-1'>{heartCounts['heart-8']}</p>
                        <svg className={heart ('heart-8') } 
                        id='heart-first'
                        stroke="currentColor" 
                        fill="currentColor" 
                        strokeWidth="0" 
            ...
            <h3 className="h3-comment">Leave a Comment</h3>
              ...
              <div>
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">Daniel</p>
                  <p className="comment-text">YESSS! I can't wait to hear what you've been working on. Darkpink always delivers the best music. Love you guys! -</p>
                  <div className="comment-info">
                    <p className="comment-date">July 13 2022</p>
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="comment-text">You guys never disappoint, and I know this new music is going to be amazing! Can't wait to add it to my playlist. 😍</p>
                  <div className="comment-info">
                    <p className="comment-date">July 13 2022 <p className='comment-count' id="fave">{heartCounts['dark']}</p>
                    {<div className="comment-actions">
                    <svg
