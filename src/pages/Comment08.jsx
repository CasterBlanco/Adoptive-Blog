import C3 from "../assets/Image-4.png";
    ...
    <div className='first-comment'>
      ...
      <Breadcrumbs />
        <div className="ourFirst">
            <h1>Feeling the love at our concert tonight! ❤️💜</h1>
            <div className="comment-creator">
                <img className="comment-avatar" src={B1} alt="" />
                <p className='comment-name'>
                    MLS Official July 13 2022       
                </p>
            </div>
            <br/>
            <p className='comment-post'>
            ARMY, you were absolutely amazing tonight at our concert! We felt your  love and energy the whole time and it was an unforgettable experience. We can't wait to come back and perform for you all again. Thank you for  making this night so special. 💜❤️
           </p>
              <div>
                      <svg className='comment' id="blog-8" stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"></path>
                      </svg>
                        <p className='comment-count'>{commentCounts['blog-9']}</p>
                        <p className='heart-count-1'>{heartCounts['heart-9']}</p>
                        <svg className={heart ('heart-9') } 
                        id='heart-first'
                        stroke="currentColor" 
                        fill="currentColor" 
                        strokeWidth="0" 
            ...
            <h3 className="h3-comment">Leave a Comment</h3>
              ...
              <div>
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">OY</p>
                  <p className="comment-text">I wish I could've been there! Your music always lifts my mood and fills me with joy. Please come back to my city soon! 💜</p>
                  <div className="comment-info">
                    <p className="comment-date">September 2, 2022
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">KL</p>
                  <p className="comment-text">You guys never disappoint! I'm so proud of all your hard work and success. Keep shining,MLS! </p>
                  <div className="comment-info">
                    <p className="comment-date">September 2, 2022 <p className='comment-count' id="fave">{heartCounts['dark']}</p>
                    {<div className="comment-actions">
                    <svg
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">Lisa</p>
                  <p className="comment-text">ARMY you were incredible tonight! The passion and love you have for MLS is truly inspiring. Can't wait to see you all again soon! </p>
                  <div className="comment-info">
                    <p className="comment-date">September 2, 2022 <p className='comment-count' id="fave">{heartCounts['MLS']}</p>
                    {<div className="comment-actions">
                    <svg
