import C3 from "../assets/Image-13.jpg";
            ...
            <h3 className="h3-comment">Leave a Comment</h3>
              ...
              <div>
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="comment-text">You look absolutely stunning Nisoo! 😍💜</p>
                  <div className="comment-info">
                    <p className="comment-date">June 23, 2023
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">Jennie</p>
                  <p className="comment-text">Can you stop being so perfect? 😩❤️</p>
                  <div className="comment-info">
                    <p className="comment-date">June 23, 2023<p className='comment-count' id="fave">{heartCounts['dark']}</p>
                    {<div className="comment-actions">
                    <svg
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="comment-text">Aww you're so adorable, Nisoo! 😘</p>
                  <div className="comment-info">
                    <p className="comment-date">June 24, 2023<p className='comment-count' id="fave">{heartCounts['MLS']}</p>
                    {<div className="comment-actions">
                    <svg
