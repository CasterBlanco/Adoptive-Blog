import C3 from "../assets/Image-17.jpg";
            ...
            <h3 className="h3-comment">Leave a Comment</h3>
              ...
              <div>
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">JoyLove</p>
                  <p className="comment-text">I'm down for some ice cream! 🍦😍</p>
                  <div className="comment-info">
                    <p className="comment-date">ONovember 4, 2023
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">AY</p>
                  <p className="comment-text">I'm always down for a good treat! 😋❤️</p>
                  <div className="comment-info">
                    <p className="comment-date">November 4, 2023<p className='comment-count' id="fave">{heartCounts['dark']}</p>
                    {<div className="comment-actions">
                    <svg
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">Raymond from BCT</p>
                  <p className="comment-text">You deserve it Mandy! 🙌🏼</p>
                  <div className="comment-info">
                    <p className="comment-date">November 5, 2023<p className='comment-count' id="fave">{heartCounts['MLS']}</p>
                    {<div className="comment-actions">
                    <svg
