import C3 from "../assets/Image-14.jpg";
      ...
      <Breadcrumbs />
        <div className="ourFirst">
            ...
            <div className="comment-creator">
                ...
                LN from MLS August 8, 2023
                </p>
            </div>
            <br/>
            <p className='comment-post'>
            Can't wait for you all to hear our new album! Stay tuned 😎</p>
              <div>
            ...
            <h3 className="h3-comment">Leave a Comment</h3>
              ...
              <div>
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">Ginger1996</p>
                  <p className="comment-text">Yessss, can't wait LN! 😍🔥</p>
                  <div className="comment-info">
                    <p className="comment-date">August 8, 2023
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">KillerQueen</p>
                  <p className="comment-text">You guys are gonna kill it as always 💜</p>
                  <div className="comment-info">
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="comment-text">I'm counting down the days! 🤩</p>
                  <div className="comment-info">
