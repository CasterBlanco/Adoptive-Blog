    ...
    <div className='first-comment'>
      ...
      <Breadcrumbs />
        <div className="ourFirst">
            <h1>Missing the stage so much!</h1>
            <div className="comment-creator">
                <img className="comment-avatar" src={B1} alt="" />
                <p className='comment-name'>
                Lennie Win (DARKPINK) April 20, 2023
                </p>
            </div>
            <br/>
            <p className='comment-post'>
            Can't wait to be back on stage and perform for all of you! The energy from the crowd is truly indescribable. It's been too long, but we'll be back soon! 💪🎶🤩
           </p>
              <div>
                      <svg className='comment' id="blog-4" stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"></path>
                        ...
                        <p className='comment-count'>{commentCounts['blog-4']}</p>
                        <p className='heart-count-1'>{heartCounts['heart-4']}</p>
                        <svg className={heart ('heart-4') } 
                        id='heart-first'
                        stroke="currentColor" 
                        fill="currentColor" 
                        strokeWidth="0" 
            ...
            <h3 className="h3-comment">Leave a Comment</h3>
              ...
              <div>
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">Anna (DARKPINK)</p>
                  <p className="comment-text">Anna (DARKPINK)
                    Can't wait to see you guys perform again! - 🥳</p>
                  <div className="comment-info">
                    <p className="comment-date">April 20, 2023 <p className='comment-count' id="fave">{heartCounts['heart-jc']}</p>
                    {<div className="comment-actions">
                    <svg
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">Ariana (HANDee)</p>
                  <p className="comment-text">I feel the same way! Nothing beats performing live in front of our fans!</p>
                  <div className="comment-info">
                    <p className="comment-date">April 20, 2023 <p className='comment-count' id="fave">{heartCounts['dark']}</p>
                    {<div className="comment-actions">
                    <svg
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">MLS_official</p>
                  <p className="comment-text">We miss you too Lennie! Can't wait to see DARKPINK back on stage! 💕🎤</p>
                  <div className="comment-info">
                    <p className="comment-date">April 20, 2023 <p className='comment-count' id="fave">{heartCounts['MLS']}</p>
                    {<div className="comment-actions">
                    <svg
