import C3 from "../assets/Image-5.png";
    ...
    <div className='first-comment'>
      ...
      <Breadcrumbs />
        <div className="ourFirst">
            ...
            We're so excited to share our latest album with all of our amazing fans! We've been working hard on this one and can't wait for you to hear it 🎶 #KpopMusic #NewAlbum           </p>
              <div>
                      <svg className='comment' id="blog-10" stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"></path>
                      </svg>
                        <p className='comment-count'>{commentCounts['blog-10']}</p>
                        <p className='heart-count-1'>{heartCounts['heart-10']}</p>
                        <svg className={heart ('heart-10') } 
                        id='heart-first'
                        stroke="currentColor" 
                        fill="currentColor" 
                        strokeWidth="0" 
            ...
            <h3 className="h3-comment">Leave a Comment</h3>
              ...
              <div>
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">MlS</p>
                  <p className="comment-text">We're already obsessed with your new music! You guys never disappoint 🙌 #ECHO</p>
                  <div className="comment-info">
                    <p className="comment-date">August 2 2023
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">DARKINK</p>
                  <p className="comment-text">Your hard work and dedication always shines through in your music. Can't wait to hear the new album 💜 #ECHO</p>
                  <div className="comment-info">
                    <p className="comment-date">August 2 2023 <p className='comment-count' id="fave">{heartCounts['dark']}</p>
                    {<div className="comment-actions">
                    <svg
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">GOT9</p>
                  <p className="comment-text">ECHO never fails to impress us with their talent and creativity. Can't wait to hear the new album! 💿 #WeAreOne</p>
                  <div className="comment-info">
                    <p className="comment-date">August 2 2023 <p className='comment-count' id="fave">{heartCounts['MLS']}</p>
                    {<div className="comment-actions">
                    <svg
