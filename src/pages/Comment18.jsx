import C3 from "../assets/Image-16.jpg";
    ...
    <div className='first-comment'>
      ...
      <Breadcrumbs />
        <div className="ourFirst">
            <h1>Trying out a new hairstyle 🤔</h1>
            <div className="comment-creator">
                <img className="comment-avatar" src={B1} alt="" />
                <p className='comment-name'>
                Nelson Lang from GOT9 October 13, 2023
                </p>
            </div>
            <br/>
            ...
            <h3 className="h3-comment">Leave a Comment</h3>
              ...
              <div>
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="comment-text">I'm loving the new look, Nelson! 😍🔥</p>
                  <div className="comment-info">
                    <p className="comment-date">October 14, 2023
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="comment-text">You can pull off any hairstyle, king! 👑💜</p>
                  <div className="comment-info">
                    <p className="comment-date">October 14, 2023<p className='comment-count' id="fave">{heartCounts['dark']}</p>
                    {<div className="comment-actions">
                    <svg
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">Shawn_STAR</p>
                  <p className="comment-text">Looking good as always, Nelson! 👌🏼</p>
                  <div className="comment-info">
