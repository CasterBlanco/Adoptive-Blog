    ...
    <div className='first-comment'>
      ...
      <Breadcrumbs />
        <div className="ourFirst">
            <h1>Happy Birthday to my best friend!</h1>
            <div className="comment-creator">
                <img className="comment-avatar" src={B1} alt="" />
                <p className='comment-name'>
                José (DARKPINK) March 15, 2023              
                </p>
            </div>
            <br/>
            <p className='comment-post'>
            Happy Birthday to the one and only Nisoo! You're not only an amazing friend, but also an incredible artist and performer. Here's to many more years of laughter and unforgettable memories. Love you always! 💕🎂🎉
           </p>
              <div>
                      <svg className='comment' id="blog-3" stroke="currentColor" fill="currentColor" strokeWidth={0} viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"></path>
                      </svg>
                        <p className='comment-count'>{commentCounts['blog-3']}</p>
                        <p className='heart-count-1'>{heartCounts['heart-3']}</p>
                        <svg className={heart ('heart-3') } 
                        id='heart-first'
                        stroke="currentColor" 
                        fill="currentColor" 
                        strokeWidth="0" 
            ...
            <h3 className="h3-comment">Leave a Comment</h3>
              ...
              <div>
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">ECNO Official</p>
                  <p className="comment-text">Happy Birthday Nisoo! You guys are friendship goals! 🥳</p>
                  <div className="comment-info">
                ...
                <div className="comment-avatar-container">
                  ...
                  <p className="anonymous">AU</p>
                  <p className="comment-text">Aww, so sweet Rosé! Happy Birthday Nisoo! 🎈</p>
                  <div className="comment-info">
